...
class Camera1Session implements CameraSession {
    ...
    private Camera1Session(Events events, boolean captureToTexture, Context applicationContext, SurfaceTextureHelper surfaceTextureHelper, MediaRecorder mediaRecorder, int cameraId, Camera camera, CameraInfo info, CaptureFormat captureFormat, long constructionTimeNs) {
    ...
    private void listenForTextureFrames() {
        this.surfaceTextureHelper.startListening(new OnTextureFrameAvailableListener() {
