...
public class WebRtcAudioManager {
    ...
    WebRtcAudioManager(long nativeAudioManager) {
        ...
        this.volumeLogger = new WebRtcAudioManager.VolumeLogger(this.audioManager);
    ...
    private static class VolumeLogger {
        ...
        public void start() {
            ...
            this.timer.schedule(new WebRtcAudioManager.VolumeLogger.LogVolumeTask(this.audioManager.getStreamMaxVolume(2), this.audioManager.getStreamMaxVolume(0)), 0L, 30000L);
        }
