...
public class NetworkMonitorAutoDetect extends BroadcastReceiver {
    ...
    static class WifiDirectManagerDelegate extends BroadcastReceiver {
        ...
        public List<NetworkInformation> getActiveNetworkList() {
            return (List<NetworkInformation>)(this.wifiP2pNetworkInfo != null ? Collections.singletonList(this.wifiP2pNetworkInfo) : Collections.emptyList());
        }
        ...
        private void onWifiP2pGroupChange(WifiP2pGroup wifiP2pGroup) {
            if (wifiP2pGroup != null && wifiP2pGroup.getInterface() != null) {
                ...
                this.wifiP2pNetworkInfo = new NetworkMonitorAutoDetect.NetworkInformation(wifiP2pGroup.getInterface(), NetworkMonitorAutoDetect.ConnectionType.CONNECTION_WIFI, 0L, ipAddresses);
    ...
    static class ConnectivityManagerDelegate {
        ...
        public void registerNetworkCallback(NetworkCallback networkCallback) {
            this.connectivityManager.registerNetworkCallback((new Builder()).addCapability(NetworkCapabilities.NET_CAPABILITY_INTERNET).build(), networkCallback);
        }
