...
class Camera2Session implements CameraSession {
    ...
    public static void create(CreateSessionCallback callback, Events events, Context applicationContext, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, MediaRecorder mediaRecorder, String cameraId, int width, int height, int framerate) {
    ...
    private Camera2Session(CreateSessionCallback callback, Events events, Context applicationContext, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, MediaRecorder mediaRecorder, String cameraId, int width, int height, int framerate) {
    ...
    private class CaptureSessionCallback extends StateCallback {
        ...
        public void onConfigured(CameraCaptureSession session) {
            ...
            try {
                Builder captureRequestBuilder = Camera2Session.this.cameraDevice.createCaptureRequest(CameraDevice.TEMPLATE_RECORD);
