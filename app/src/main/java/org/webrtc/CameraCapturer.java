...
abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    private void reportUpdateMediaRecorderError(String error, MediaRecorderHandler mediaRecoderEventsHandler) {
    ...
    private void updateMediaRecorderInternal(MediaRecorder mediaRecorder, MediaRecorderHandler mediaRecoderEventsHandler) {
        this.checkIsOnCameraThread();
    ...
    protected abstract void createCameraSession(CreateSessionCallback var1, Events var2, Context var3, SurfaceTextureHelper var4, MediaRecorder var5, String var6, int var7, int var8, int var9);
