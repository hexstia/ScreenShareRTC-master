...
public class MediaCodecVideoEncoder {
    ...
    private static final MediaCodecVideoEncoder.MediaCodecProperties exynosH264HighProfileHwProperties;
    private static final MediaCodecVideoEncoder.MediaCodecProperties[] h264HighProfileHwList;
            ...
            for(int i = 0; i < MediaCodecList.getCodecCount(); ++i) {
                ...
                if (info != null && info.isEncoder()) {
                    ...
                    if (name != null) {
                        ...
                        MediaCodecVideoEncoder.MediaCodecProperties[] var22 = supportedHwCodecProperties;
                        int var24 = supportedHwCodecProperties.length;

                        int var10;
                        for(var10 = 0; var10 < var24; ++var10) {
                            MediaCodecVideoEncoder.MediaCodecProperties codecProperties = var22[var10];
    ...
    boolean initEncode(MediaCodecVideoEncoder.VideoCodecType type, int profile, int width, int height, int kbps, int fps, Context sharedContext) {
        ...
        if (this.mediaCodecThread != null) {
            ...
            if (type == MediaCodecVideoEncoder.VideoCodecType.VIDEO_CODEC_VP8) {
                ...
                if (profile == MediaCodecVideoEncoder.H264Profile.CONSTRAINED_HIGH.getValue()) {
                    MediaCodecVideoEncoder.EncoderProperties h264HighProfileProperties = findHwEncoder("video/avc", h264HighProfileHwList, useSurface ? supportedSurfaceColorList : supportedColorList);
            ...
            if (properties == null) {
                ...
                try {
                    ...
                    Logging.e("MediaCodecVideoEncoder", "initEncode failed", var14);
                    this.release();
                    return false;
                }
            }
    ...
    static {
        ...
        qcomVp9HwProperties = new MediaCodecVideoEncoder.MediaCodecProperties("OMX.qcom.", 24, MediaCodecVideoEncoder.BitrateAdjustmentType.NO_ADJUSTMENT);
        exynosVp9HwProperties = new MediaCodecVideoEncoder.MediaCodecProperties("OMX.Exynos.", 24, MediaCodecVideoEncoder.BitrateAdjustmentType.FRAMERATE_ADJUSTMENT);
        ...
        exynosH264HighProfileHwProperties = new MediaCodecVideoEncoder.MediaCodecProperties("OMX.Exynos.", 23, MediaCodecVideoEncoder.BitrateAdjustmentType.FRAMERATE_ADJUSTMENT);
        h264HighProfileHwList = new MediaCodecVideoEncoder.MediaCodecProperties[]{exynosH264HighProfileHwProperties};
